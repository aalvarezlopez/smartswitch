...
/** \brief  Reverse byte order (32 bit)
    ...
    \return               Reversed value
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __REV(
    uint32_t value)
{
    uint32_t result;
...
/** \brief  Reverse byte order (16 bit)
    ...
    \return               Reversed value
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __REV16(
    uint32_t value)
{
    uint32_t result;
...
/** \brief  Reverse byte order in signed short value
    ...
    \return               Reversed value
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE int32_t __REVSH(
    int32_t value)
{
    uint32_t result;
    ...
    uint32_t value, volatile uint32_t* addr)
{
    ...
    __ASM volatile ("strex %0, %2, [%1]" : "=&r" (result) : "r" (addr),
                    "r" (value) );
    return (result);
}
